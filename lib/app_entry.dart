        ...
        builder: (context, snapshot) {
          ...
          return MultiProvider(
            providers: [
              ...
              ChangeNotifierProvider(create: (context) => DetailProductVM()),
              // ChangeNotifierProvider(create: (context) => RoutesVM()),
            ],
            child: Selector<ProductListVM, String>(
              ...
              builder: (context, locale, child) => MaterialApp(
                ...
                theme: ThemeData(
                  ...
                  primaryColor: const Color.fromRGBO(18, 40, 112, 1),
                  colorScheme: const ColorScheme.light(
                      secondary: Color.fromRGBO(236, 83, 20, 1),
                      primary: Color.fromRGBO(18, 40, 112, 1)),
                  bottomNavigationBarTheme: const BottomNavigationBarThemeData(
                    backgroundColor: Color.fromRGBO(18, 40, 112, 1),
                    selectedItemColor: Color.fromRGBO(236, 83, 20, 1),
                  ),
                ),
